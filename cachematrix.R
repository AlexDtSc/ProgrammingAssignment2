...
### Example for confirming the rightness of functions
...
W <- matrix(c(2,5,4,5,8,3,5,9,3),3,3)
W


W1 <- makeCacheMatrix(W)
cacheSolve(W1) #inverse returned after computation

cacheSolve(W1) #inverse returned from cache
